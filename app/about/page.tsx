        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center text-center gap-4 mb-10 md:mb-12">
            <div className="flex items-center justify-center">
              <RootlyLogo
                size={112}
                className="text-foreground md:h-28 md:w-28 h-24 w-24"
              />
            </div>
            ...
            <p className="max-w-2xl text-muted-foreground">
              A simple learning tool to capture questions, review them
              carefully, and see your progress over time.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              Rootly Notes is a personal knowledge notebook focused on clarity.
              Add notes as question–answer pairs, track understanding from 1–5,
              and see trends that guide your next study session.
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              Learning sticks when questions drive it. This project removes
              difficulty so you can quickly capture what you don't know, review
              carefully, and make steady, measurable progress.
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground">
              Inspired by spaced repetition, the idea of simple notes with one
              idea each, and a desire for calm, beautiful interfaces that keep
